...
1. **Installing VScode**
* My laptop already had VScode downloaded prior because of my CSE 11 class last quarter. If you do not already have it downloaded, you can go to [Link][1]
⋮
[1]: https://code.visualstudio.com/ and follow the directions to download the application. 
