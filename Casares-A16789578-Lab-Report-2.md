...
* The two screenshots above show what happens when I use `add-message`. At first, the url of type URI changed since I added the path "add-message" and query "?s=slay". That would then change the string called `inputs` to "slay \n", where \n is a new line.

* The second time around, the url of type URI changed again since I added the path "add-message" and querry "?s=yass". That would then change the string inputs to "slay \n yass \n", where "\n" is a new line.
